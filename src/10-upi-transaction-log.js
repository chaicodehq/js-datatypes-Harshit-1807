...
export function analyzeUPITransactions(transactions) {
  ...
  const highestTransaction = validTransactions.reduce((maxTxn, txn) => txn.amount > maxTxn.amount ? txn : maxTxn, validTransactions[0]);
  ...
  const frequentContact = Object.entries(contactCount).reduce((maxContact, [contact, count]) => count > contactCount[maxContact] ? contact : maxContact, Object.keys(contactCount)[0]);
