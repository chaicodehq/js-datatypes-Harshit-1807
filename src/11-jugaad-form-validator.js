...
export function validateForm(formData) {
  ...
  if(!formData || typeof formData !== 'object') {
    return { isValid: false, errors: { formData: "Form data is required" } };
  }
  ...
  if(typeof email !== 'string' || email.indexOf('@') === -1 || email.indexOf('@') !== email.lastIndexOf('@') || email.indexOf('.', email.indexOf('@')) === -1) {
  ...
  if(typeof pincode !== 'string' || pincode.length !== 6 || !/^\d{6}$/.test(pincode) || pincode.startsWith('0')) {
